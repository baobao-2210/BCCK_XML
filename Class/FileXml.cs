...
namespace Quanlybangiay.Class
{
    class FileXml
    {   
        string Conn = @"Data Source=.;Initial Catalog=QuanLyBanGiay;User ID=sa;Password=12345;Encrypt=True;TrustServerCertificate=True";
        // Đọc file XML (tính từ thư mục chạy ứng dụng) vào DataTable để hiển thị/xử lý.
